...
class Issue(models.Model):
    ...
    assignedTo = models.ManyToManyField(User, related_name='assigned_issues', blank=True)
    description = models.TextField()
    tipo = models.ForeignKey(TipoIssue, on_delete=models.SET_NULL, null=True, blank=True)
    estado = models.ForeignKey(EstadoIssue, on_delete=models.SET_NULL, null=True, blank=True)
    prioridad = models.ForeignKey(PrioridadIssue, on_delete=models.SET_NULL, null=True, blank=True)
    severidad = models.ForeignKey(SeveridadIssue, on_delete=models.SET_NULL, null=True, blank=True)
